...
const stats = [
  { 
    ...
    icon: <Truck size={28} />,   // ✅ Users ki jagah Truck
    color: "from-blue-500 to-indigo-600", 
    tab: "delivery" 
  },
  { title: "Revenue", icon: <DollarSign size={28} />, color: "from-green-500 to-emerald-600" },
  { title: "Growth", icon: <TrendingUp size={28} />, color: "from-pink-500 to-rose-600" },
  { title: "Deliveries", icon: <Package size={28} />, color: "from-purple-500 to-indigo-600" },
];
            ...
            >
              {stats.map((item, i) => (
                <motion.div
                  ...
                  onClick={() => item.tab && setActiveTab(item.tab)} // ✅ Click par tab change
